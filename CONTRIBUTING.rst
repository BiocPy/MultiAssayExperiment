...
Welcome to ``MultiAssayExperiment`` contributor's guide.
...
If you experience bugs or general issues with ``MultiAssayExperiment``, please have a look
...
You can help improve ``MultiAssayExperiment`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``MultiAssayExperiment`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``MultiAssayExperiment``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n MultiAssayExperiment python=3 six virtualenv pytest pytest-cov
    conda activate MultiAssayExperiment
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/MultiAssayExperiment.git
    cd MultiAssayExperiment
...
#. Install |pre-commit|_::
   ...
   ``MultiAssayExperiment`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/MultiAssayExperiment
.. _issue tracker: https://github.com/<USERNAME>/MultiAssayExperiment/issues
.. <-- end -->
