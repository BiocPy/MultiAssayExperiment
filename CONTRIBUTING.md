...
`MultiAssayExperiment` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/MultiAssayExperiment
[issue tracker]: https://github.com/<USERNAME>/MultiAssayExperiment/issues
